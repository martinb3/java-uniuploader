...
import org.mbs.juniuploader.objects.remoteobjects.FormPair;
    ...
    public static void postFileUpload(UploadRule ur)
    {
        ...
        try {
            ...
            if (status == HttpStatus.SC_OK) {
                ...
                org.mbs.juniuploader.StatusThread.addMessage("Done with " + ur);
            } else {
                log.info("postFileUpload encounted HTTP Error for " + fname + " to "+ ur);
                org.mbs.juniuploader.StatusThread.addMessage("Failed with " + ur);
            }
